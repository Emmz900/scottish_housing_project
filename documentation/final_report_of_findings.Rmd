...
An app was created to explore both the overall rating over the years, and distribution of ratings within each year. The data can be explored across the different council areas, as well as the different categories provdide. The app has two tabs, one for neighbourhood rating and one for community belonging.
